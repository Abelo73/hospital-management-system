...
public class TrainingService {
    ...
    public BaseResponseDTO<List<TrainingDTO>> getTrainings(String status, String startDate, String endDate, Pageable pageable) {
        try {
            Page<Training> trainings;
            if (status != null) {
                trainings = trainingRepository.findByStatus(status, pageable);
            ...
            return BaseResponseDTO.success("Trainings retrieved", trainingMapper.toDTOList(trainings.getContent()));
        } catch (Exception e) {
