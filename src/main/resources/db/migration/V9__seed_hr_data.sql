...
INSERT INTO hr_compliance (id, employee_id, compliance_type, document_name, document_url, issuing_authority, issue_date, expiry_date, status, reminder_date, notes, created_by)
VALUES
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP001'), 'MEDICAL_LICENSE', 'Medical Practitioner License', '/documents/licenses/emp001_medical_license.pdf', 'Medical Practitioners and Dentists Board', '2020-01-10', '2025-01-10', 'ACTIVE', '2024-10-01', 'Annual license renewal required', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP002'), 'NURSING_LICENSE', 'Nursing Council License', '/documents/licenses/emp002_nursing_license.pdf', 'Nursing Council of Kenya', '2019-05-20', '2024-05-20', 'ACTIVE', '2024-02-01', 'Annual license renewal required', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP003'), 'PHARMACY_LICENSE', 'Pharmacist License', '/documents/licenses/emp003_pharmacy_license.pdf', 'Pharmacy and Poisons Board', '2021-02-15', '2026-02-15', 'ACTIVE', '2025-11-01', 'Annual license renewal required', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP004'), 'LAB_LICENSE', 'Medical Laboratory License', '/documents/licenses/emp004_lab_license.pdf', 'Kenya Medical Laboratory Technicians and Technologists Board', '2020-08-25', '2025-08-25', 'ACTIVE', '2025-05-01', 'Annual license renewal required', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP007'), 'MEDICAL_LICENSE', 'Medical Practitioner License', '/documents/licenses/emp007_medical_license.pdf', 'Medical Practitioners and Dentists Board', '2019-10-20', '2024-10-20', 'ACTIVE', CURRENT_DATE - INTERVAL '30 days', 'License expiring soon - renewal initiated', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP001'), 'BLS_CERTIFICATION', 'Basic Life Support', '/documents/certifications/emp001_bls.pdf', 'American Heart Association', '2023-06-15', '2024-06-15', 'ACTIVE', '2024-03-01', 'Annual BLS certification', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP002'), 'BLS_CERTIFICATION', 'Basic Life Support', '/documents/certifications/emp002_bls.pdf', 'American Heart Association', '2023-07-20', '2024-07-20', 'ACTIVE', '2024-04-01', 'Annual BLS certification', (SELECT id FROM users WHERE username = 'admin')),
(gen_random_uuid(), (SELECT id FROM hr_employees WHERE employee_number = 'EMP008'), 'HR_CERTIFICATION', 'SHRM-CP', '/documents/certifications/emp008_shrm.pdf', 'Society for Human Resource Management', '2022-03-10', '2025-03-10', 'ACTIVE', '2024-12-01', 'Professional HR certification', (SELECT id FROM users WHERE username = 'admin'));
